...
public class SignInActivity extends BaseActivity {
    ...
    private void signIn() {
        ...
        try {
            ...
            params.put("device_country_code", getResources().getConfiguration().locale.getCountry());
            params.put("device_language", Locale.getDefault().getLanguage());
            params.put("$device_local_code", Locale.getDefault().getISO3Language());
            params.put("device_default_time_zone", TimeZone.getDefault().getID());
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, BASE_URL + "loginForUser", body, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (response.getInt("code") == 200) {
                        App.putString(App.TOKEN, data.getString("token"));
                        App.putUser(user);
...
//        RequestQueue queue = Volley.newRequestQueue(this);
//
//        StringRequest stringRequest = new StringRequest(Request.Method.POST, BASE_URL+"loginForUser", response -> {
//            bind.ll.setClickable(true);
//            bind.pb.setVisibility(View.GONE);
//
//            try {
